...
{
    public partial class BisiparişMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    İş = table.Column<string>(maxLength: 50, nullable: true),
                    Girişİsim = table.Column<string>(maxLength: 30, nullable: false),
                    Şifre = table.Column<string>(maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OluşturuKimsiId = table.Column<int>(nullable: false),
                    TarihVeZaman = table.Column<DateTime>(nullable: false),
                    MüşteriId = table.Column<int>(nullable: true),
                    PaketMi = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sepetler_Müşteriler_MüşteriId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SepetlerÖğeler_Sepetler_SepetId",
                        column: x => x.SepetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sepetler_MüşteriId",
                table: "Sepetler",
                column: "MüşteriId");

            migrationBuilder.CreateIndex(
                name: "IX_SepetlerÖğeler_SepetId",
                table: "SepetlerÖğeler",
                column: "SepetId");
        }
