...
{
    public partial class HazırlaMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ad = table.Column<string>(maxLength: 40, nullable: false),
                    Tür = table.Column<byte>(nullable: false),
                    Fotoğraf = table.Column<byte[]>(nullable: true),
                    Fiyat = table.Column<float>(nullable: false),
                    Betimleme = table.Column<string>(maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Oluşturulduğunda = table.Column<DateTime>(nullable: false),
                    OluşturuKimsiId = table.Column<int>(nullable: false),
                    İsim = table.Column<string>(maxLength: 70, nullable: false),
