...
namespace HazırlaWebArkaUç
{
    ...
    public class HazırlaWebYardımcı
    {
        ...
        //        catch (Exception ex)
        //        {
        //            Task.Run(async () => await HazırlaWebYardımcı.GünlükKaydetme(OlaySeviye.Hata, ex.Message));
        //            return "(ERROR!)";
        //        }
        //    }
        //    set
        ...
        //            HazırlaWebYardımcı.ŞuAnkiKullanıcıMenü = Partial("_SistemYöneticiMenüKısmiGörüntü");
        //            break;
