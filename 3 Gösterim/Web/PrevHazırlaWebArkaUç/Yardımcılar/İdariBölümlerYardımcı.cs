...
namespace HazırlaWebArkaUç.Yardımcılar
{
    public class İdariBölümlerYardımcı
    {
        ...
        private static string İdariBölümlerUrl => $"{HazırlaWebYardımcı.ArkaUçHizmetUrl}/İdariBölümler";
        public static List<İl> İller => HazırlaWebYardımcı.MemCache.Get("İller") as List<İl>;
        public static List<İlçe> İlçeler => HazırlaWebYardımcı.MemCache.Get("İlçeler") as List<İlçe>;
        public static List<Semt> Semtler => HazırlaWebYardımcı.MemCache.Get("Semtler") as List<Semt>;
        public static List<Mahalle> Mahalleler => HazırlaWebYardımcı.MemCache.Get("Mahalleler") as List<Mahalle>;
        #endregion
